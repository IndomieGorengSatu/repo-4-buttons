...
[![Deploy to heroku](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/SsxMedusa/testbot1)

## Deploy in your VPS
````bash
git clone https://github.com/github.com/SsxMedusa/testbot1
cd testbot1
pip3 install -r requirements.txt
cp sample_config.env config.env
# edit config.env Anda dan isi VARS menggunakan nano config.env CTRL + S untuk menyimpan VARS Anda, 
# gunakan CTRL + X untuk keluar dan kembali ke direktori testbot1
bash start
````
